...
plot(t, data(:,1), 'LineWidth', 2, 'DisplayName', 'Sai số X (m)'); hold on;
plot(t, data(:,2), 'LineWidth', 2, 'DisplayName', 'Sai số Y (m)');
plot(t, data(:,3), 'LineWidth', 2, 'DisplayName', 'Sai số Góc (rad)');
